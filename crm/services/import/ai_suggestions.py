    ...
    *,
    ...
    envelope = {
        ...
        "rules": {
            ...
            "person_profile_verification_method": {
                "build_likely_username_variants": True,
                "require_public_profile_page": True,
                "require_title_or_bio_identity_match": True,
                "reject_organization_or_venue_pages": True,
                "omit_weak_identity_matches": True,
            },
        },
        "instructions": [
            ...
            "Consider variants like firstnamelastname, firstname.lastname, firstname_lastname, lastnamefirstname, and first-initial plus lastname.",
            "Also consider Norwegian character simplification such as æ to ae, ø to o, and å to aa.",
            "A person social profile is only strong when the public page exists and the page title, display name, bio, or surrounding snippet matches the person.",
            "Reject or downgrade pages that look like organizations, venues, festivals, employers, fan accounts, or generic listings.",
    ...
    *,
    ...
    envelope = {
        ...
        "instructions": [
            ...
            "For Instagram, Facebook, and TikTok person profiles, use a deterministic verification method rather than guessing.",
            "Build likely username variants from the person's name, including firstnamelastname, firstname.lastname, firstname_lastname, lastnamefirstname, and first-initial plus lastname.",
            "Also consider Norwegian character simplification such as æ to ae, ø to o, and å to aa.",
            "Treat a person profile as strong only when the public page exists and the title, display name, bio, or snippet clearly matches the person.",
            "Reject or downgrade candidates that look like organization pages, venue pages, festival pages, fan accounts, or generic directory pages.",
            "If identity evidence is weak, omit the social profile instead of guessing.",
