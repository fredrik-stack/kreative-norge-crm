...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name="importimagedecision",
            constraint=models.CheckConstraint(condition=models.Q(models.Q(("decision_kind", "SET_APPROVED_IMAGE"), models.Q(("source_type_snapshot", ""), _negated=True), models.Q(("approval_text_version_snapshot", ""), _negated=True), models.Q(("approval_text_snapshot", ""), _negated=True), models.Q(("asset_checksum_sha256_snapshot", ""), _negated=True), models.Q(("asset_validation_version_snapshot", ""), _negated=True)), models.Q(("approval_text_snapshot", ""), ("approval_text_version_snapshot", ""), ("asset_checksum_sha256_snapshot", ""), ("asset_validation_version_snapshot", ""), ("decision_kind__in", ["KEEP_LOCKED_IMAGE", "USE_APPROVED_FALLBACK"]), ("provider_snapshot", ""), ("source_page_url_snapshot", ""), ("source_type_snapshot", ""), ("source_url_snapshot", ""), ("technical_warnings_snapshot", [])), _connector="OR"), name="imp_img_approval_snapshot_contract"),
        ),
        migrations.AddConstraint(
            model_name="importimagedecision",
