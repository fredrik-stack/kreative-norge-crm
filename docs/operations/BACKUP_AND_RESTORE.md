...
Fase 3E.1B har `/srv/kreative-norge/media/public-delivery/` eksplisitt i den aktive `HOST_MEDIA_PATHS`-allowlisten og compose-/storagefoundation. Området er opprettet `root:root` mode `0750`, API-mountet og holdt utenfor web. Foundationgaten beviste persistence og restore med en midlertidig probe. Etter materialiseringsaktiveringen inneholder rooten én permanent syntetisk release med tre filer; post-activation-backup `kreative-norge-staging-20260823T185950Z`, full repository-/arkivverifikasjon og isolert restore av samme arkiv er grønne. `PUBLIC_IMAGE_RELEASE_MATERIALIZATION_ENABLED=True` aktiverer fortsatt ikke public serving. Se [foundationevidensen](../status/STAGING_PHASE_3E1B_FOUNDATION_2026-08-23.md) og [aktiveringsevidensen](../status/STAGING_PHASE_3E1B_MATERIALIZATION_ACTIVATION_2026-08-23.md).

Fase 3E.1C er deretter `ACTIVE` i staging med to release-aggregater og seks delivery-filer. Post-serving-activation-backup `kreative-norge-staging-20260823T220249Z` bestod full repository-/dataverifikasjon og isolert restore `2026-08-23T22:03:22Z`. Dette beviser backup/restore av den aktive controlled-serving-staten, men aktiverer ikke projection, PUBLIC eller takedown. Se [3E.1C-evidensen](../status/STAGING_PHASE_3E1C_ACTIVATION_2026-08-24.md).
