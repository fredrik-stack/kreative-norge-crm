...
Den separate [aktiveringsgaten](../status/STAGING_PHASE_3E1C_ACTIVATION_2026-08-24.md) beviste alle tre varianter, checksum-`ETag`, HEAD/304, tomme 404/405/503-svar, bridge- og filfeil, origins, logger, mountisolasjon, restart og backup/restore. Rollback er bare å sette servingflagget av og rekreere API/web. 3E.2 projection/API-shadow er senere [stagingverifisert](../status/STAGING_PHASE_3E2_SHADOW_2026-08-24.md). 3E.3 legger til separate `PUBLIC_IMAGE_API_SCHEMA_ENABLED`- og `PUBLIC_IMAGE_PUBLIC_CUTOVER_ENABLED`-gater med kode-/eksempelstandard `False`. PUBLIC-cutover krever projection, targetschema, controlled serving og gyldige origins; [stagingaktivering og rollback](../status/STAGING_PHASE_3E3_CUTOVER_2026-08-24.md) er grønne, og de ignorerte stagingverdiene er `True`. Formell takedown og 3E.4 er fortsatt uimplementert.
