...
Den separate [aktiveringsgaten](../status/STAGING_PHASE_3E1C_ACTIVATION_2026-08-24.md) beviste alle tre varianter, checksum-`ETag`, HEAD/304, tomme 404/405/503-svar, bridge- og filfeil, origins, logger, mountisolasjon, restart og backup/restore. Rollback er bare å sette servingflagget av og rekreere API/web. Projection, API/PUBLIC, legacy-cutover, takedown og 3E.2–3E.4 inngår ikke og er fortsatt uimplementert.
