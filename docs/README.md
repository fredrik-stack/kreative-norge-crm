...
Operativ safety-kontrakt finnes i `operations/PUBLIC_IMAGE_SAFETY_LEDGER.md`. Safety-ledger, dedikert off-server anchor og restore-gate fra 3E.1A er `ACTIVE` i staging. 3E.1B.1–3E.1B.2-materialisering og 3E.1C kontrollert Django/Nginx-serving er også `ACTIVE`. Fase 3E.2 er `CLOSED / SHADOW VERIFIED`, og fase 3E.3 er `CLOSED / ACTIVE`: target-API, PUBLIC, canonical, Open Graph/Twitter og production fallback v1 bruker samme projection i staging. Fase 3E.4 er `CLOSED / ACTIVE` etter ledger-v2-upgrade, permanent syntetisk deny, rollback, mediarestore, sikker republisering, restart og backup/restore. Fase 3F og hele fase 3 er `CLOSED / VERIFIED` etter legacyinventar, typed Import-kontrakt, no-network, restore og orphan-gate; `IMPORT_IMAGE_DECISIONS_ENABLED` er fortsatt av i shared staging. Fase 4A er godkjent og merget med [ADR-010](decisions/ADR-010-INTERNATIONAL_PHONE_IDENTITY_AND_NORMALIZATION.md) via PR #56. Fase 4B er `READY_FOR_4C` etter en [skrivebeskyttet, personvernredigert stagingbaseline](status/STAGING_PHASE_4B_PHONE_BASELINE_2026-08-25.md). Fase 4C er `READY_FOR_4D` etter [API-only stagingverifikasjon](status/STAGING_PHASE_4C_PHONE_NORMALIZATION_2026-08-25.md) av [det rene telefonnormaliseringsdomenet](architecture/PHONE_NORMALIZATION.md) uten dataendring; ingen modell eller caller er koblet til. Kode- og eksempelstandardene for alle runtime-/write-gater er fortsatt `False`; bare de sju 3E-gatene er aktivert i den ignorerte stagingkonfigurasjonen. Staging har fire release-aggregater og ni delivery-filer; den denied releasen har ingen originfiler. Se [3E.2-evidensen](status/STAGING_PHASE_3E2_SHADOW_2026-08-24.md), [3E.3-cutoverevidensen](status/STAGING_PHASE_3E3_CUTOVER_2026-08-24.md), [3E.4-takedownevidensen](status/STAGING_PHASE_3E4_TAKEDOWN_2026-08-24.md), [3F-evidensen](status/STAGING_PHASE_3F_LEGACY_IMPORT_2026-08-25.md), [4B-evidensen](status/STAGING_PHASE_4B_PHONE_BASELINE_2026-08-25.md) og [4C-evidensen](status/STAGING_PHASE_4C_PHONE_NORMALIZATION_2026-08-25.md).
