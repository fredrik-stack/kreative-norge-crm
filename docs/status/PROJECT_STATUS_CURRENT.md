...
**Status:** Fase 1 og 2 gjennomført; fase 3A, fase 3B.1 og fase 3B.2 teknisk gjennomført; lokal Hetzner storage-/backup-MVP ACTIVE; fase 3C har avslått konfigurasjon og additiv bilde-, selection- og event-/kommandogrunnmur for ordinær lock, replacement, fjerning til fallback og restore som ny revisjon, uten runtimebruk

**Teknisk sist verifisert:** 2026-08-06
...
[Fase 3B.1R-A](PHASE_3B1R_REPRESENTATIVE_QUALITY_HARNESS.md) forbereder en isolert, lokal og rettighetsstyrt datasett-, analyse- og reviewramme. Kildebilder og privat manifest er Git-ignorert; runneren bruker eksplisitte source-/outputrøtter, ingen nettverk og én child-prosess per fixture. Harnesset måler ICC-/sRGB-status, crop/no-upscale, advisory edge variance/blockiness, logowhitespace, kandidat-pixelgrenser, tid og peak RSS og lager lokal visuell evidens samt redacted maskinevidens. Det finnes ikke et privat representativt datasett i repoet, så fase 3B.1R er ikke gjennomført og ingen endelig pixel-, dimensjons-, blur-, komprimerings-, logolesbarhets- eller sRGB-regel er besluttet.
...
Fase 3A-kartleggingen, ADR-007 og de isolerte prototypene i fase 3B.1 og fase 3B.2 er gjennomført. Prosjekteier har godkjent tilhørende processing-, storage-, delivery-, takedown- og restoreprinsipper, og ADR-008s lokale Hetzner-MVP er ACTIVE. Fase 3C har avslått featureflag, ubrukte lokale image-storagealiaser, additive bilde-/selection-modeller og ubrukte, atomiske kommandoer for locking/replacement, ordinær fjerning til fallback og restore av en eksplisitt arkivert asset-selection som ny revisjon med append-only events. Filskriving, storage-runtime, øvrig eventhistorikk, serving og offentlig bildebruk er fortsatt ikke implementert; fase 3B.1R og øvrige kvalitetsgater må være grønne før reell bildebruk kan aktiveres.
