...
| [ADR-009](ADR-009-PUBLIC_IMAGE_RUNTIME_RELEASE_DELIVERY_AND_RESTORE_SAFE_DENY_STATE.md) | Public image runtime, release delivery og restore-safe deny state | Godkjent; 3E.1A ACTIVE, 3E.1B-kontrakt godkjent, runtime gjenstår |
