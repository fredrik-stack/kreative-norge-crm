...
Disse valgene endrer ikke hovedarkitekturen. Fase 3B.1R, fase 3B.3, fase 3B.3-A-domenegrunnmuren, operativ aktivering av ADR-008-backupen og ADR-009s fase 3E.1A–3E.1C er gjennomført som beslutnings-, implementerings- og evidensgater. 3E.2 er implementert default-off, men må fortsatt stagingbevises; 3E.3–3E.4 skal implementeres og bevises før PUBLIC-kobling eller formell takedown aktiveres.
