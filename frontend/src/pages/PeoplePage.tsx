        ...
        <>
          ...
          <form onSubmit={editor.onSubmitPerson} className="editor-form">
            ...
            <Field label="Interne tags">
              <input
                value={editor.personInternalTagInput}
                onChange={(e) => editor.setPersonInternalTagInput(e.target.value)}
                placeholder="f.eks. ny kontakt, prioritet, intern oppfølging"
              />
              <TagSuggestions
                value={editor.personInternalTagInput}
                tags={editor.internalTags}
                onSelect={(nextValue) => editor.setPersonInternalTagInput(nextValue)}
                pillClassName="mini-pill internal-tag suggestion-chip"
                ariaLabel="Eksisterende interne tags"
              />
              <p className="muted" style={{ margin: "6px 0 0" }}>
                Interne tags er kun synlige internt og har ingen øvre grense.
              </p>
            </Field>
